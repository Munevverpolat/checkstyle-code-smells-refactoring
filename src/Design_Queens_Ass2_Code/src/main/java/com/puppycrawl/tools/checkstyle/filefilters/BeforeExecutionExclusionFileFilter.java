...
public final class BeforeExecutionExclusionFileFilter extends AbstractAutomaticBean
    ...
    /**
     * Checks if a file is accepted based on the pattern.
     *
     * @param uri the file URI
     * @return true if accepted, false if excluded
     */
    private boolean isAccepted(String uri) {
        return fileNamePattern == null || !fileNamePattern.matcher(uri).find();
    }

    /**
     * Checks if a file matches the exclusion pattern.
     *
     * @param uri the file URI
    ...
    /**
     * Checks if a pattern is set for this filter.
     *
     * @return true if a pattern exists
     */
