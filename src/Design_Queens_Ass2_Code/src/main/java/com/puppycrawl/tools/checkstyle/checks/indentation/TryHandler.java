...
public class TryHandler extends BlockParentHandler {
    ...
    public IndentLevel getSuggestedChildIndent(AbstractExpressionHandler child) {
        ...
        if (child instanceof CatchHandler
            || (child instanceof BlockParentHandler && "finally".equals(((BlockParentHandler) child).getHandlerName()))//Refactored Code
            || (child instanceof NewHandler && isTryBlocksResourceSpecification(child))) {//Refactored Code
        result = getIndent();
    }
    else {
